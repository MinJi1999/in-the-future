  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      ...
      <div>
        <Switch>
          <Route
            path="/product/letterpaper"
            component={Auth(LetterPaper, true)}
            exact
          />
          <Route
            path="/product/:productId"
            component={Auth(LetterDetail, true)}
            exact
          />
          ...
          <Route
            exact
            path="/upload/letter"
            component={Auth(LetterUpload, true)}
          />
          <Route
            exact
            path="/user/history"
          ...
          />
          <Route exact path="/user/cart" component={Auth(Custom, true)} />
        </Switch>
      </div>
    </Suspense>
  );
