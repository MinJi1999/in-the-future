...
function LetterUpload(props) {
  ...
  const dropHandler = (files) => {
    ...
    axios
      ...
      .catch((err) => alert(err, "편지를 저장하는데 실패했습니다. 다시 시도해주세요"));
  };
  ...
  return (
    <section className="letter-upload">
      ...
      <div className="upload-container">
        <Dropzone onDrop={dropHandler}>
          {({ getRootProps, getInputProps }) => (
            <div>
              <div className="pic-uploader" {...getRootProps()}>
                <input {...getInputProps()} />
              ...
              <div className="uploader-sentence">
                - 편지는 최대 4장까지 추가가 가능합니다.
                <br />
                - 글씨가 잘 보이도록 찍어주세요.
                <br />
                - 손글씨로 적어내신다면 알아볼 수 있게 적어주세요.
                <br />
                - 편지 상단에 회원가입 때에 적으셨던 성함을 적어주세요.
                <br />
                - 편지 마지막에는 받고 싶은 날짜를 적어주세요.
                <br />
                - 정성을 다해 편지를 옮겨 담을게요.
                <br />
              </div>
      ...
      <Notify visible = {visible} text={'편지 업로드가 완료되었습니다.'} />    </section>
  );
}
